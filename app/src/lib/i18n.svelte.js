...
const dictionary = {
  fr: {
    ...
    "expenses.filterAll": "Toutes les opérations",
    "expenses.filterExpenses": "Dépenses (Sorties)",
    "expenses.filterIncomes": "Rentrées (CAF, etc.)",
    ...
    "cal.incomeBadge": "Rentrée",

    // Income / Rentrées d'argent
    "income.addBtn": "+ Rentrée d'argent",
    "income.dialogTitle": "Enregistrer une Rentrée d'Argent",
    "income.subtitle": "CAF, APL, prime, remboursement santé ou vente",
    "income.btnSubmit": "Enregistrer la Rentrée",
    "income.amountLabel": "Montant de la rentrée (€)",
    "income.labelLabel": "Libellé de l'opération",
    "income.categoryLabel": "Catégorie",
    "income.targetAccount": "Compte récepteur",
    "income.dateLabel": "Date de réception",
    "income.cafAides": "CAF / Aides sociales",
    "income.remboursement": "Remboursement Mutuelle / Santé",
    "income.prime": "Prime / Bonus",
    "income.cadeau": "Cadeau / Virement",
    "income.vente": "Vente d'occasion",
    "income.autre": "Autre rentrée",
    "income.notice": "Cette entrée sera immédiatement créditée sur le solde de votre compte et apparaîtra en vert sur votre Calendrier de Trésorerie.",

    // Evolution & Balance History
    "evolution.dialogTitle": "Historique & Évolution du Compte",
    "evolution.subtitle": "Suivi des variations de solde, valorisations et logs",
    "evolution.btnEvolution": "Évolution & Historique",
    "evolution.currentBalance": "Solde actuel",
    "evolution.globalChange": "Dernière variation",
    "evolution.addValuation": "Actualiser la valorisation",
    "evolution.newBalanceLabel": "Nouveau solde (€)",
    "evolution.motifLabel": "Motif de l'ajustement",
    "evolution.saveValuation": "Enregistrer la valorisation",
    "evolution.noHistory": "Aucun historique enregistré pour ce compte.",
    "evolution.colDate": "Date & Heure",
    "evolution.colOldNew": "Évolution de Solde",
    "evolution.colDelta": "Variation",
    "evolution.colMotif": "Motif / Commentaire",
  ...
  en: {
    ...
    "expenses.filterAll": "All operations",
    "expenses.filterExpenses": "Expenses (Debits)",
    "expenses.filterIncomes": "Incomings (CAF, etc.)",
    ...
    "cal.incomeBadge": "Income",

    // Income / Rentrées d'argent
    "income.addBtn": "+ Add Income",
    "income.dialogTitle": "Record an Income / Deposit",
    "income.subtitle": "CAF, housing allowance, bonus, health refund, or sale",
    "income.btnSubmit": "Record Income",
    "income.amountLabel": "Income amount (€)",
    "income.labelLabel": "Transaction label",
    "income.categoryLabel": "Category",
    "income.targetAccount": "Receiving account",
    "income.dateLabel": "Reception date",
    "income.cafAides": "CAF / Social benefits",
    "income.remboursement": "Health / Insurance refund",
    "income.prime": "Bonus / Incentive",
    "income.cadeau": "Gift / Family transfer",
    "income.vente": "Resale / Second-hand",
    "income.autre": "Other income",
    "income.notice": "This income will instantly credit your account balance and appear in green on your Cash Flow Calendar.",

    // Evolution & Balance History
    "evolution.dialogTitle": "Account History & Evolution",
    "evolution.subtitle": "Track balance fluctuations, valuations, and audit logs",
    "evolution.btnEvolution": "Evolution & History",
    "evolution.currentBalance": "Current balance",
    "evolution.globalChange": "Latest variation",
    "evolution.addValuation": "Update valuation",
    "evolution.newBalanceLabel": "New balance (€)",
    "evolution.motifLabel": "Adjustment reason",
    "evolution.saveValuation": "Save valuation",
    "evolution.noHistory": "No history recorded for this account.",
    "evolution.colDate": "Date & Time",
    "evolution.colOldNew": "Balance Evolution",
    "evolution.colDelta": "Variation",
    "evolution.colMotif": "Reason / Note",
